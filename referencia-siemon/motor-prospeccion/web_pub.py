...
BASE = os.path.join(os.path.dirname(os.environ.get("CRM_DATA", "/data/crm.json")), "webfiles")
...
# archivo local (en BASE) -> ruta remota en el hosting (la cuenta FTP entra directo a la raiz web)
ARCHIVOS = {
    "index.html": {"remoto": "index.html", "nombre": "Página principal (home)"},
    "main.js": {"remoto": "main.js", "nombre": "Textos e idiomas de la home (main.js)"},
    "proposal.html": {"remoto": "proposal.html", "nombre": "Presentación / propuestas"},
    "blog/index.html": {"remoto": "blog/index.html", "nombre": "Blog público"},
    "download-guide/index.html": {"remoto": "download-guide/index.html", "nombre": "Landing de la guía"},
    "formulario-descubrimiento/index.html": {"remoto": "formulario-descubrimiento/index.html", "nombre": "Formulario de diagnóstico"},
    "styles.css": {"remoto": "styles.css", "nombre": "Estilos de la home (styles.css)"},
    "404.html": {"remoto": "404.html", "nombre": "Página de error 404 (marca Siemon)"},
    ".htaccess": {"remoto": ".htaccess", "nombre": "Configuración del hosting (404 propia)"},
}
...
def publicar_html(remoto, html):
    ...
    try:
        ...
        try:
            ...
            pass
    return {"ok": True, "url": "https://siemondigital.com/" + remoto}
