...
export var T = {
    es: {
      ...
      pnInvertible: 'Flujo que inviertes (50/30/20)',
      ...
      pnFaseTitulo: 'Tu fase del ciclo · propiedades por ronda', pnFaseEscal: 'Escalamiento', pnFaseRecap: 'Recapitalización', pnFaseConsol: 'Consolidación',
      pnFaseNota: 'A medida que crece tu poder de inversión, subes de fase y puedes asumir más propiedades por ciclo (1‑2 → 2‑3 → 4‑5).',
      pnAfcEyebrow: 'Ahorro fiscal inmediato', pnAfcHelp: 'Aportando a una cuenta deducible (tipo AFC/AVC, tope 30% del ingreso) reduces tu base gravable y ahorras impuesto al instante, según tu tasa marginal.',
      pnAfcAporte: 'Aporte deducible (30% del ingreso)', pnAfcAhorro: 'Ahorro inmediato (anual)', pnAfcTasa: 'Tu tasa marginal',
      pnAfcNota: 'El ahorro real depende de tu tramo impositivo y del vehículo de tu país. Consulta a tu asesor tributario.',
      pnXbEyebrow: 'Retención transfronteriza', pnXbHelp: 'Al repatriar ganancias de proyectos en moneda extranjera, la fuente puede retener impuesto. Un tratado (CDI) o una participación >5% suele reducirlo mucho.',
      pnXbProys: 'Proyectos en el exterior', pnXbSinCdi: 'Retención estimada sin tratado (~27,5%)', pnXbConCdi: 'Con tratado / CDI',
      pnXbAviso: '🟡 Tienes exposición transfronteriza · verifica si hay tratado (CDI) entre tu país de residencia y el del inmueble antes de repatriar.',
      pnXbOk: '🟢 Sin exposición transfronteriza en moneda extranjera por ahora.',
      pnXbNota: 'Regla general (Cap. 38): sin CDI, retención en la fuente 25–30%; con tratado o participación >5%, suele bajar a 0–10%. Verifica con tu asesor.',
    ...
    en: {
      ...
      pnInvertible: 'Flow you invest (50/30/20)',
      ...
      pnFaseTitulo: 'Your cycle phase · properties per round', pnFaseEscal: 'Scaling', pnFaseRecap: 'Recapitalization', pnFaseConsol: 'Consolidation',
      pnFaseNota: 'As your investing power grows, you move up a phase and can take on more properties per cycle (1‑2 → 2‑3 → 4‑5).',
      pnAfcEyebrow: 'Immediate tax saving', pnAfcHelp: 'Contributing to a deductible account (AFC/AVC-type, capped at 30% of income) lowers your taxable base and saves tax right away, at your marginal rate.',
      pnAfcAporte: 'Deductible contribution (30% of income)', pnAfcAhorro: 'Immediate saving (annual)', pnAfcTasa: 'Your marginal rate',
      pnAfcNota: 'Actual saving depends on your tax bracket and your country’s vehicle. Check with your tax advisor.',
      pnXbEyebrow: 'Cross-border withholding', pnXbHelp: 'When you repatriate gains from foreign-currency projects, the source country may withhold tax. A treaty (DTA) or a >5% stake usually reduces it sharply.',
      pnXbProys: 'Projects abroad', pnXbSinCdi: 'Est. withholding without treaty (~27.5%)', pnXbConCdi: 'With treaty / DTA',
      pnXbAviso: '🟡 You have cross-border exposure · check whether a treaty (DTA) exists between your country of residence and the property’s before repatriating.',
      pnXbOk: '🟢 No foreign-currency cross-border exposure for now.',
      pnXbNota: 'Rule of thumb (Ch. 38): without a DTA, source withholding is 25–30%; with a treaty or a >5% stake it usually drops to 0–10%. Verify with your advisor.',
