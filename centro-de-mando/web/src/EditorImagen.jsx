...
const C = {
  ...
  aetherLine: "rgba(230,199,136,0.30)", cream: "#F4EFE6", mist: "#D7D7D9", ash: "#8B8D98", ok: "#7FB89B",
};
...
const AETHER = [177, 163, 225];   // violeta de marca #E6C788
// marca de agua: la linea del ciclo de Atlantis (circulo orbital)
