...
def postiz_base():
    return os.environ.get("POSTIZ_URL", "https://publicar.atlantisglobalrealty.com/api").rstrip("/") + "/public/v1"


def postiz_key():
    import secretos
    return secretos.get("POSTIZ_API_KEY") or os.environ.get("POSTIZ_API_KEY", "")
...
def _publicar_nativo(req):
    url = os.environ.get("N8N_PUBLICAR_URL", "https://hooks.atlantisglobalrealty.com/webhook/atlantis-publicar")
