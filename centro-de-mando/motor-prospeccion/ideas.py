...
# Pilares default (editables por config): dolores del avatar de Atlantis.
PILARES_BILINGUE = [
    {"es": "invertir en bienes raices sin experiencia", "en": "real estate investing for beginners"},
    {"es": "libertad financiera y patrimonio", "en": "financial freedom building wealth"},
    {"es": "que hacer con tus ahorros", "en": "what to do with your savings"},
]
_REGION = {"es": "CO", "en": "US"}
_CACHE = {}
...
def _api_key():
    import secretos
    return secretos.get("YOUTUBE_API_KEY") or os.environ.get("YOUTUBE_API_KEY")
